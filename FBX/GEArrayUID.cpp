...
//----------------------------------------------------------------
bool GEArrayUID::InitArray(soint32 nElementSize, soint32 nInitCapacity, soint32 nAddCount)
{
	m_nUsingElementCount = 0;
...
//----------------------------------------------------------------
bool GEArrayUID::ResizeArray(soint32 newCapacity)
{
...
//----------------------------------------------------------------
soint32 GEArrayUID::FillAt(soint32 nUID, const void* pElement)
{
	if (m_pElementBuff == 0)
	{
		return -1;
...
//----------------------------------------------------------------
soint32 GEArrayUID::TakeNew(void** ppElement)
{
	if (m_pElementBuff == 0)
	{
		return -1;
...
//----------------------------------------------------------------
void GEArrayUID::ClearAt(soint32 nUID)
{
	if (m_pStatusBuff == 0)
	{
		return;
...
//----------------------------------------------------------------
void* GEArrayUID::GetAt(soint32 nUID) const
{
...
////----------------------------------------------------------------
//soint32 GEArrayUID::GetStatus(soint32 nUID) const
//{
...
//}
//----------------------------------------------------------------
soint32 GEArrayUID::GetUID(const void* pElement, soint32 nValidSize) const
{
	if (pElement == 0)
	{
		return -1;
...
//----------------------------------------------------------------
soint32 GEArrayUID::FindFirstEmptyElement()
{
	if (m_pStatusBuff == 0)
	{
		return -1;
