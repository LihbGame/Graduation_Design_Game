...
//----------------------------------------------------------------
SoD3DShaderModelFbx::SoD3DShaderModelFbx()
:m_pInputLayout(0)
,m_pFxEffect(0)
,m_pFxTech(0)
...
//----------------------------------------------------------------
bool SoD3DShaderModelFbx::InitShaderModelFbx()
{
	if (D3DApp::Get() == 0)
	{
		return false;
...
//----------------------------------------------------------------
void SoD3DShaderModelFbx::ClearShaderModelFbx()
{
	if (m_pInputLayout)
	{
...
//----------------------------------------------------------------
void SoD3DShaderModelFbx::ProcessRender(void* pParam)
{
...
//----------------------------------------------------------------
bool SoD3DShaderModelFbx::CreateInputLayout()
{
	if (m_pFxTech == 0)
	{
		return false;
