...
//--------------------------------------------------------------------
void GETimeHelp::GetTimeTM(stTimeTM* pMT)
{
	return GetTimeTMByTimestamp(pMT, GetTimestamp());
}
//--------------------------------------------------------------------
void GETimeHelp::GetTimeTM_Millisecond(stTimeTM* pMT)
{
	if (pMT == 0)
	{
		return;
...
//--------------------------------------------------------------------
int GETimeHelp::GetLocalTimestamp()
{
	stTimeTM kMT;
	GetLocalTimeTM(&kMT);
...
//--------------------------------------------------------------------
void GETimeHelp::GetLocalTimeTM(stTimeTM* pMT)
{
	tm ktm;
...
//--------------------------------------------------------------------
void GETimeHelp::GetLocalTimeTM_Millisecond(stTimeTM* pMT)
{
	if (pMT == 0)
	{
		return;
...
//--------------------------------------------------------------------
int GETimeHelp::GetTimestampByTimeTM(stTimeTM* pMT)
{
	if (pMT == 0)
	{
		return 0;
...
//--------------------------------------------------------------------
void GETimeHelp::GetTimeTMByTimestamp(stTimeTM* pMT, const int nTimestamp)
{
	if (pMT == 0)
	{
		return;
