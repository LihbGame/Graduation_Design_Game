//----------------------------------------------------------------
#ifndef _GEArrayUID_h_
#define _GEArrayUID_h_
//----------------------------------------------------------------
...
//----------------------------------------------------------------
inline soint32 GEArrayUID::GetCapacity() const
{
	return m_nCapacity;
}
//----------------------------------------------------------------
inline soint32 GEArrayUID::GetUsingElementCount() const
{
	return m_nUsingElementCount;
}
//----------------------------------------------------------------
#endif //_GEArrayUID_h_
//----------------------------------------------------------------
