...
GED3DShaderModelKK::GED3DShaderModelKK()
:m_pInputLayout(0)
,m_pFxEffect(0)
,m_pFxTech(0)
,m_pFxWorldMatrix(0)
...
//----------------------------------------------------------------
bool GED3DShaderModelKK::InitShaderModelKK()
{
	if (D3DApp::Get() == 0)
	{
		return false;
...
//----------------------------------------------------------------
void GED3DShaderModelKK::ClearShaderModelKK()
{
	if (m_pInputLayout)
	{
...
//----------------------------------------------------------------
void GED3DShaderModelKK::ProcessRender(void* pParam)
{
...
//----------------------------------------------------------------
bool GED3DShaderModelKK::CreateInputLayout()
{
	if (m_pFxTech == 0)
	{
		return false;
