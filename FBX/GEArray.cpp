...
//----------------------------------------------------------------
bool GEArray::InitArray(__int32 nElementSize, __int32 nInitCapacity, __int32 nAddCount)
{
	m_nSize = 0;
	m_nDeltaAddRemove = 0;
...
//----------------------------------------------------------------
bool GEArray::ResizeArray(__int32 newCapacity)
{
...
//----------------------------------------------------------------
__int32 GEArray::PushBack(const void* pElement)
{
	if (pElement == 0)
	{
		return -1;
...
//----------------------------------------------------------------
__int32 GEArray::TakeNew(void** ppElement)
{
	if (ppElement == 0)
	{
		return -1;
...
//----------------------------------------------------------------
__int32 GEArray::InsertAt(__int32 nIndex, const void* pElement)
{
	if (nIndex < 0)
	{
		nIndex = 0;
...
//----------------------------------------------------------------
bool GEArray::RemoveAt(__int32 nIndex)
{
...
//----------------------------------------------------------------
bool GEArray::Remove(const void* pElement)
{
	bool br = false;
...
//----------------------------------------------------------------
bool GEArray::SwapAt(__int32 nIndexA, __int32 nIndexB)
{
...
//----------------------------------------------------------------
void* GEArray::GetAt(__int32 nIndex) const
{
...
//----------------------------------------------------------------
__int32 GEArray::GetIndex(const void* pElement, __int32 nValidSize) const
{
	if (pElement == 0)
	{
		return -1;
...
//----------------------------------------------------------------
__int32 GEArray::FindEmptyElement() const
{
	__int32 theUID = -1;
