...
//------------------------------------------------------------
bool GEReadFile::LoadFile(const char* pFileName)
{
...
//------------------------------------------------------------
const char* GEReadFile::GetFirstLine()
{
	m_nReadPos = 0;
	return GetNextLine();
}
//------------------------------------------------------------
const char* GEReadFile::GetNextLine()
{
...
//------------------------------------------------------------
int GEReadFile::GetLineLen() const
{
	return m_nLineLen;
}
//------------------------------------------------------------
