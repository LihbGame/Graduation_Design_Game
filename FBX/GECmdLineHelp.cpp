...
//-----------------------------------------------------------------------------
#define GECmdLineHelp_GlobalBuffSize 2048
//-----------------------------------------------------------------------------
//公共缓存区，用于存储返回值
char g_CmdLineBuff[GECmdLineHelp_GlobalBuffSize] = { 0 };
...
//-----------------------------------------------------------------------------
char* GECmdLineHelp::GetValueByKey(const char* szCmdLine, const int nCmdLength, const char* szKey)
{
	//清空公共缓存区
	g_CmdLineBuff[0] = 0;
	...
	const int nKeyLen = GEStrLen(szKey);
...
//-----------------------------------------------------------------------------
int GECmdLineHelp::GetIntByKey(const char* szCmdLine, const int nCmdLength, const char* szKey, const int nDefaultValue)
{
	const char* szValue = GetValueByKey(szCmdLine, nCmdLength, szKey);
	if (szValue[0] != 0)
	{
		return GEatoi(szValue);
	}
	else
	{
...
//-----------------------------------------------------------------------------
float GECmdLineHelp::GetFloatByKey(const char* szCmdLine, const int nCmdLength, const char* szKey, const float fDefaultValue)
{
	const char* szValue = GetValueByKey(szCmdLine, nCmdLength, szKey);
	if (szValue[0] != 0)
	{
		return (float)GEatof(szValue);
	}
	else
	{
...
//-----------------------------------------------------------------------------
wchar_t* GECmdLineHelp::GetValueByKey_W(const wchar_t* szCmdLine, const int nCmdLength, const wchar_t* szKey)
{
	//清空公共缓存区
	g_WCmdLineBuff[0] = 0;
	...
	const int nRealCmdLen = (nCmdLength == -1) ? 999999 : nCmdLength;
	const int nKeyLen = GEWStrLen(szKey);
...
//-----------------------------------------------------------------------------
int GECmdLineHelp::GetIntByKey_W(const wchar_t* szCmdLine, const int nCmdLength, const wchar_t* szKey, const int nDefaultValue)
{
	const wchar_t* szValue = GetValueByKey_W(szCmdLine, nCmdLength, szKey);
	if (szValue[0] != 0)
	{
		return GEWatoi(szValue);
	}
	else
	{
		return nDefaultValue;
...
//-----------------------------------------------------------------------------
float GECmdLineHelp::GetFloatByKey_W(const wchar_t* szCmdLine, const int nCmdLength, const wchar_t* szKey, const float fDefaultValue)
{
	const wchar_t* szValue = GetValueByKey_W(szCmdLine, nCmdLength, szKey);
	if (szValue[0] != 0)
	{
		return (float)GEWatof(szValue);
	}
	else
	{
		return fDefaultValue;
