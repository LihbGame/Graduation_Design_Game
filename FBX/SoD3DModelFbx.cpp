...
//----------------------------------------------------------------
void SoD3DModelFbx::RenderModel(Model_Tansform_Info *Mode_info,int Instance_Num)
{
...
//----------------------------------------------------------------
void SoD3DModelFbx::SetTexture(const wchar_t* szFileName)
{
...
//----------------------------------------------------------------
bool SoD3DModelFbx::CreateTexture(const wchar_t* szFileName)
{
	ReleaseTexture();
	//
