...
void HeightmapTerrain::Draw(ID3D11DeviceContext* dc, const Camera& cam, DirectionalLight lights[3])
{
	...
	Effects::TerrainFX->SetGrassMap(mGrassMapSRV);
...
void HeightmapTerrain::BuildQuadPatchVB(ID3D11Device* device)
{
...
void HeightmapTerrain::BuildQuadPatchIB(ID3D11Device* device)
{
...
void HeightmapTerrain::BuildHeightmapSRV(ID3D11Device* device)
{
